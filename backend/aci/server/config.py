...
# OPENSEARCH
OPENSEARCH_AWS_REGION = check_and_get_env_variable("SERVER_OPENSEARCH_AWS_REGION")
OPENSEARCH_HOST = check_and_get_env_variable("SERVER_OPENSEARCH_HOST")
OPENSEARCH_PORT = int(check_and_get_env_variable("SERVER_OPENSEARCH_PORT"))
OPENSEARCH_LOG_INDEX_PATTERN = check_and_get_env_variable("SERVER_OPENSEARCH_LOG_INDEX_PATTERN")
OPENSEARCH_USERNAME = check_and_get_env_variable("SERVER_OPENSEARCH_USERNAME")
OPENSEARCH_PASSWORD = check_and_get_env_variable("SERVER_OPENSEARCH_PASSWORD")
